...
.alert-critical,.alert-high,.alert-medium,.alert-ok{border-radius:2px;padding:1.2rem;margin:.5rem 0;color:#fff}.alert-critical{background:#5b1d16;border-left:5px solid #e26b50}.alert-high{background:#672815;border-left:5px solid #db7a41}.alert-medium{background:#614510;border-left:5px solid #d9a73d}.alert-ok{background:#283424;border-left:5px solid #6c9860}.alert-critical p,.alert-high p,.alert-medium p,.alert-ok p{color:#f3eee7!important}.result-box{border-radius:2px;padding:1.8rem;margin:1rem 0;text-align:center}.job-card{background:#fff;padding:1rem 1.2rem;border:1px solid var(--line);border-left:5px solid #77695c;margin:.5rem 0}.job-card.urgent{border-left-color:#a93b2b}.job-card.done{border-left-color:#557047;opacity:.75}
